...
Sky_Knight_Missile = {
    ...
    ModelData = {
		...
		0.075,   -- characteristic square (характеристическая площадь) old 0.09 -- 4
		
		-- Cx dependency parameters
		0.0175 , -- Cx_k0 plank Cx0 of subsonics ( M << 1) old 0.1 -- 0.17
		0.0575 , -- Cx_k1 peak height of the wave crisis old 0.1 -- 0.22
		0.005 , -- Cx_k2 steepness of the front on the way to the wave crisis 
		0.0275, -- Cx_k3 bar Cx0 on supersonic ( M >> 1) old 0.06 -- 0.033
		0.8 , -- Cx_k4 steepness of the decline behind the wave crisis old 1.2 -- 2.0
		0.6 , -- polar dump coefficient (proportional to sqrt (M^2-1)) 
		
		-- Cy dependency parameters
		0.6 , -- Cy_k0 plank Sy0 on reverberation ( M << 1) old 0.8 -- 1.57
		0.5	 , -- Cy_k1 plank Cy0 on supersonic ( M >> 1)
		0.8  , -- Cy_k2 steepness of the recession (front) behind the wave crisis
...
--    t_statr        t_b     t_accel     t_march     t_inertial        t_break        t_end            -- Stage
        0.0,        0.3,    0.01,          4.25,        0.0,            0.0,        1.0e9,         -- time of stage, sec
         0.0,        0.0,    0.0,        5.0,        0.0,            0.0,        0.0,           -- fuel flow rate in second, kg/sec(секундный расход массы топлива кг/сек)
...
GT_t.LN_t.SkyKnight_Missile.reflection_limit = 0;
