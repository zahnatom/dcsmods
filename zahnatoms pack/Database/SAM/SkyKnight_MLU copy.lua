...
Sky_Knight_Missile = {
	...
	active_radar_lock_dist	= 140000.0,
    ...
    ModelData = {
		...
		0.0.025 , -- Cx_k0 plank Cx0 of subsonics ( M << 1) old 0.1 -- 0.17
		0.0.065 , -- Cx_k1 peak height of the wave crisis old 0.1 -- 0.22
		0.01.02 , -- Cx_k2 steepness of the front on the way to the wave crisis 
		0.0.035, -- Cx_k3 bar Cx0 on supersonic ( M >> 1) old 0.06 -- 0.033
...
--    t_statr        t_b     t_accel     t_march     t_inertial        t_break        t_end            -- Stage
        0.0,        0.5,    0.01,          5.0,        0.0,            0.0,        1.0e9,         -- time of stage, sec
         ...
         999999999999999999999, -- self-destruction timer, sec
		180.0,  -- power system operation time, sec
		0,  -- absolute altitude of self-destruction, m
		0.5, -- control activation delay time (departure, safety maneuver), sec
...
GT_t.LN_t.SkyKnight_Missile.launch_delay = 0.000000009;
